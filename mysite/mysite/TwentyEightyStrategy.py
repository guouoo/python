...
def calcreturn(request):
    ...
    Message.info = ''
    size = 25
    title = '二八趋势轮动策略模型： ' + str(datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S"))
    # print(title)
    Message.info += title +'<br>'
